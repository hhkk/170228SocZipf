...
import { UtdsListComponent } from './utds-list.component';
import { UtdDetailsComponent } from './utd-details.component';
...
import {UtdsUploadComponent} from "./utds-upload.component";
